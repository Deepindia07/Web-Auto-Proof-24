...
class ResetPasswordScreenBloc extends Bloc<ResetPasswordScreenEvent, ResetPasswordScreenState> {
  ...
  ResetPasswordScreenBloc({required this.repository}) : super(ResetPasswordScreenInitial()) {
  ...
  Future<void> _onPasswordSubmitted(
    ...
    try {
      ...
      emit(ResetPasswordScreenFailure(error: 'Unexpected error occurred: $error'));
    }
  }
}
