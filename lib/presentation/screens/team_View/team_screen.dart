...
class _MyTeamScreenState extends State<MyTeamScreen> {
  final List<MyTeamModel> myTeamModelList = [
    MyTeamModel(
                  ...
                  Expanded(
                    child: Container(
                      child: ListView.separated(
                        ...
                        itemCount: myTeamModelList.length,
                        separatorBuilder: (context, index) => SizedBox(

                          height: 1,
                        ),
                        itemBuilder: (context, index) {
                          final teamList = myTeamModelList[index];
                          return _teamItem(teamList);
                        },
                      ),
                    ),
                  ),
  ...
  Widget _teamItem(MyTeamModel payment) {
    return Container(
