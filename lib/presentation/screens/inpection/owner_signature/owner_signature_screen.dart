...
class OwnerSignatureScreen extends StatelessWidget {
  const OwnerSignatureScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider<OwnerSignatureScreenBloc>(
      create: (context) => OwnerSignatureScreenBloc(),
      child: OwnerSignatureScreenView(),
    );
  }
}

class OwnerSignatureScreenView extends StatefulWidget {
  const OwnerSignatureScreenView({super.key});

  @override
  State<OwnerSignatureScreenView> createState() =>
      _OwnerSignatureScreenViewState();
}

class _OwnerSignatureScreenViewState extends State<OwnerSignatureScreenView> {
