class ApiEndPoints {
  static const String baseUrl = "http://192.168.1.3:3002";
  ...
  static const String getTeamMember = '/api/admin/team/getInspectorMemberDetails/';
  static const String updateTeamMemberInfo = '/api/admin/update-inspector-details/';
  static const String getAllVehicleList = '/api/admin/vehicle/get-all-vehicle-detailList';
}
